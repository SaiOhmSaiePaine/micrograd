...
The project includes a `draw_dot` function that visualizes the computational graph. This is incredibly helpful for debugging and understanding gradient flow.

![Computational Graph](computation_graph.png)

*Above: An example of the DAG (Directed Acyclic Graph) generated by the engine.*
---
